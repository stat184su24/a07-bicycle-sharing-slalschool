...
### Your code here
Trips <- Trips %>%
  mutate(duration = as.numeric(edate - sdate) / 3600) 
...
Trips %>%
  ...
  geom_density(fill = "gray", color = NA) +
  labs(title = "Bike Usage by Day of Year", x = "Day of Year", y = "Density") +
  theme_minimal()
...
### Your Code Here
Trips %>%
  ggplot(aes(x = wday(sdate, label = TRUE))) +
  geom_density(fill = "gray", color = NA) +
  labs(title = "Bike Usage by Day of Week", x = "Day of Week", y = "Density") +
  theme_minimal()
...
Trips %>%
  ...
  geom_density(fill = "gray", color = NA) +
  labs(title = "Bike Usage by Hour of Day", x = "Hour of Day", y = "Density") +
  theme_minimal()
...
Trips %>%
  ...
  geom_density(fill = "gray", color = NA) +
  labs(title = "Bike Usage by Minute of Hour", x = "Minute of Hour", y = "Density") +
  theme_minimal()
...
Trips %>%
  ...
  group_by(hour, day, client) %>%
  summarise(count = n()) %>%
  ggplot(aes(x = hour, y = count, color = client)) +
  geom_line() +
  facet_wrap(~ day) +
  labs(title = "Bike Rentals Grouped by Hour, Day, and Client Type", 
       x = "Hour of Day", 
       y = "Count of Rentals") +
  theme_minimal()
...
```{r}
### My code here
Trips_with_distances <- Trips %>%
  inner_join(PairDistances, by = c("sstation", "estation"))

Trips_with_distances %>%
  ggplot(aes(x = distance)) +
  geom_density(fill = "gray", color = NA) +
  labs(title = "Distribution of Trip Distances", x = "Distance (km)", y = "Density") +
  theme_minimal()
